...
class CommandList:
    character_list = [Character(*i) for i in (
        ...
        ('komachi', "IS THAT THE GRIM REAPER?!", 'onozuka_komachi', False),
        ('wakasagihime', "Sushi?", 'wakasagihime', False),
        ('toyohime', "Peaches!", 'watatsuki_no_toyohime', False),
        ('yorihime', "Has the power of god(s) and anime on her side", 'watatsuki_no_yorihime', False),
        ...
        ('elly', "Maybe it's a dream. Maybe nothing else is real.", 'elly_(touhou)', False),
        ('kasen', "placeholder description", 'ibaraki_kasen', False),
        ('keine', "History", 'kamishirasawa_keine', False),
        ...
        ('momiji', "Awooooooo", 'inubashiri_momiji', False),
        ...
        ('reisen', "bnnuy", 'reisen_udongein_inaba', True),
        ...
        ('yuuka', "Smug sunflower girl :D", 'kazami_yuuka', False),
        ('suika', "An alcoholic oni that could beat your dad in a drinking contest.", 'ibuki_suika', False),
        ('sekibanki', "Can you do this? *Yeets own head at you*", 'sekibanki', False),
        ('wriggle', "bug", 'wriggle_nightbug', False),
        ('hina', "placeholder description", 'kagiyama_hina', False),
        ('alice', "Marisa's number one simp (please don't kill me that's a joke)", 'alice_margatroid', False),
        ...
        ('kaguya', "Queen of calculus. Capable of manipulating the instantaneous and eternal", 'houraisan_kaguya+-jokanhiyou', True),
        ('eirin', "placeholder description", 'yagokoro_eirin', True),
        ('kanako', "placeholder description", 'yasaka_kanako', False),
        ('chen', "Cheeeeeeeeeen! *nosebleeds*", 'chen', False),
        ...
        ('joon', 'Like Marisa but a better thief', 'yorigami_jo\'on', False),
    )]
    alias_commands = (
        ...
        ('mokou', 'Cute fire girl that can endure more pain than your dad can exert with his belt',
         'fujiwara_no_mokou+-jokanhiyou', True),
        ('satori', "A cute pink-haired girl that always knows what hentai you've been watching", 'komeiji_satori',
         True),
        ('sanae', 'Most of the time called "Green Reimu," she\'s a sister in law and a slut.', 'kochiya_sanae', False),
        ('yukari', 'A youkai that can manipulate gaps and is often known as "Gap Hag."', 'yakumo_yukari', False),
        ('suika', 'An alcoholic oni that could beat your dad in a drinking contest.', 'ibuki_suika', False),
        ...
        ('koakuma', "Funny little devil that works for Patchouli", 'koakuma', False),
    ('yuuka', "Smug sunflower girl :D", 'kazami_yuuka', False),
    ('elly', "Bad Apple?", 'elly_(touhou)', False),
    ('joon', 'Like Marisa but a better thief', 'yorigami_jo\'on', False),
    ('unyu', 'unyu?~', 'unyu', False)
    )
